...
const (
	...
	CGenDaoUsage  = `gf gen logic [OPTION]`
...
func init() {
	gtag.Sets(g.MapStrStr{
		`CGenDaolConfig`:                  CGenDaoConfig,
		`CGenDaolUsage`:                   CGenDaoUsage,
		`CGenDaolBrief`:                   CGenDaoBrief,
		`CGenDaolEg`:                      CGenDaoEg,
		`CGenDaolAd`:                      CGenDaoAd,
		`CGenDaolBriefPath`:               CGenDaoBriefPath,
		`CGenDaolBriefLink`:               CGenDaoBriefLink,
		`CGenDaolBriefTables`:             CGenDaoBriefTables,
		`CGenDaolBriefTablesEx`:           CGenDaoBriefTablesEx,
		`CGenDaolBriefPrefix`:             CGenDaoBriefPrefix,
		`CGenDaolBriefRemovePrefix`:       CGenDaoBriefRemovePrefix,
		`CGenDaolBriefRemoveFieldPrefix`:  CGenDaoBriefRemoveFieldPrefix,
		`CGenDaolBriefStdTime`:            CGenDaoBriefStdTime,
		`CGenDaolBriefWithTime`:           CGenDaoBriefWithTime,
		`CGenDaolBriefDaoPath`:            CGenDaoBriefDaoPath,
		`CGenDaolBriefDoPath`:             CGenDaoBriefDoPath,
		`CGenDaolBriefEntityPath`:         CGenDaoBriefEntityPath,
		`CGenDaolBriefApiPath`:            CGenDaoBriefApiPath,
		`CGenDaolBriefGJsonSupport`:       CGenDaoBriefGJsonSupport,
		`CGenDaolBriefImportPrefix`:       CGenDaoBriefImportPrefix,
		`CGenDaolBriefOverwriteDao`:       CGenDaoBriefOverwriteDao,
		`CGenDaolBriefModelFile`:          CGenDaoBriefModelFile,
		`CGenDaolBriefModelFileForDao`:    CGenDaoBriefModelFileForDao,
		`CGenDaolBriefDescriptionTag`:     CGenDaoBriefDescriptionTag,
		`CGenDaolBriefNoJsonTag`:          CGenDaoBriefNoJsonTag,
		`CGenDaolBriefNoModelComment`:     CGenDaoBriefNoModelComment,
		`CGenDaolBriefClear`:              CGenDaoBriefClear,
		`CGenDaolBriefTypeMapping`:        CGenDaoBriefTypeMapping,
		`CGenDaolBriefGroup`:              CGenDaoBriefGroup,
		`CGenDaolBriefJsonCase`:           CGenDaoBriefJsonCase,
		`CGenDaolBriefTplDaoIndexPath`:    CGenDaoBriefTplDaoIndexPath,
		`CGenDaolBriefTplDaoInternalPath`: CGenDaoBriefTplDaoInternalPath,
		`CGenDaolBriefTplDaoDoPathPath`:   CGenDaoBriefTplDaoDoPathPath,
		`CGenDaolBriefTplDaoEntityPath`:   CGenDaoBriefTplDaoEntityPath,
		`CGenDaolBriefTplDaoApiPath`:      CGenDaoBriefTplDaoApiPath,
	})
}
...
type (
	CGenDao      struct{}
	CGenDaoInput struct {
		g.Meta             `name:"logic" config:"{CGenDaoiConfig}" usage:"{CGenDaoiUsage}" brief:"{CGenDaoBrief}" eg:"{CGenDaoiEg}" ad:"{CGenDaoAd}"`
